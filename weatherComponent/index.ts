...
import {WeatherDataList} from './weatherDataList/WeatherDataList'
...
export class weatherComponent implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    private generateWeatherData(): IWeatherData[] { 
        ...
        for (let i = 0; i < 5; i++) { 
            ...
            if (temperature <= -5) weatherType = WeatherType.SNOW;
             ...
             weatherData.push({ date: date, temperature: temperature, weatherType: weatherType }); 
        } 
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement): void
    {
        ...
        this.container.setAttribute('class', 'weather-data-container')
